...
> **Current widget (2026-09-01):** `FCMChatWidget` v2.10.24 targets `/relay` through
...
### HUD identity cosmetics (widget v2.10.24)
...
chat bridge strips unknown JSON members before they reach Scaleform, so v2.10.24 also reads a
