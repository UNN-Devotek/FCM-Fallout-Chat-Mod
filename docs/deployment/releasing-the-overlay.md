...
```powershell
.\Packaging\release.ps1 -Version X.Y.Z -BridgeZip "<validated-0.2.8-prod.zip>" [-ReleaseNotes "..."] [-SkipBuild] [-DryRun] [-SkipWindowsNexus]
...
```powershell
.\Packaging\package-downloads.ps1 -Version X.Y.Z -BridgeZip "<validated-0.2.8-prod.zip>"
```
...
- `Fallout Chat Mod Portable X.Y.Z.zip` — portable guide plus optional bridge folder.
  ...
  `803759975d541745ad9a434cf0ba2c7cd193e22abde92b10e4c1e638c2ed2b26`.
