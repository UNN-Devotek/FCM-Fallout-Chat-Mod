...
> SharedHUDTools, not this socket/HUDMenu architecture. See [the engineering guide](../../overlay/zfe/scaleform-ui-guide.md).
...
architecture; the modern widget does not. See [two-way-chat-implemented.md](../../archive/overlay/zfe/two-way-chat-implemented.md) for the implemented result.
