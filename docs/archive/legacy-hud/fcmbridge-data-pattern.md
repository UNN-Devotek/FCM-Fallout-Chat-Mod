...
> xScal. Use [the HUD index](../../overlay/zfe/README.md) and [current integration](../../overlay/zfe/native-chat-relay/fcm-integration.md).
...
([api-reference.md](zfe-api-reference.md) etc.); this doc records what those articles
do NOT tell you.
