...
> in [FCM integration](../../overlay/zfe/native-chat-relay/fcm-integration.md) and [auth](../../backend/auth.md).
...
> Discord-role gated. The implementation details are authoritative in [backend/auth.md](../../backend/auth.md).
...
to elevated administration and role-gated Dev access. See [auth.md](../../backend/auth.md#steam-website-accounts-and-optional-discord-profile-linking).
