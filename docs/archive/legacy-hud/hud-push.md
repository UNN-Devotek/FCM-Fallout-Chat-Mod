...
authenticated `/ws` JSON message catalog described in [websocket-protocol.md](../../realtime/websocket-protocol.md).
...
**[docs/overlay/zfe/realtime-socket.md](realtime-socket.md)**
...
- **Per-connection channel filter:** each connection has an `activeChannelId` (default: General,
  ...
  inbound verb table in [realtime-socket.md](realtime-socket.md).
