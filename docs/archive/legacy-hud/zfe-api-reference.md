...
> For new code, use [the provider guide](../../overlay/zfe/modder-guide.md) and linked author contracts. In particular,
...
Read the [Modder Guide](../../overlay/zfe/modder-guide.md) first for bridge discovery, call mechanics, logging, and testing discipline.
...
**New mods should use `__ZFE.call(command, payloadJson)` — see the [Modder Guide](../../overlay/zfe/modder-guide.md).**
