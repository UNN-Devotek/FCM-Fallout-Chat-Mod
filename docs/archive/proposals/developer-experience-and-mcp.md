...
- **Game mod:** native HUD chat uses `/relay`; the optional Server bridge uses
  provider-scoped local exports and the overlay's authenticated WebSocket.
...
- Add the dev-facing docs to the AGENTS.md documentation map.
