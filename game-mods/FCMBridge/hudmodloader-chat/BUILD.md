...
> **Widget version:** 2.9.1. This is the optional in-game HUD-mod track. It is
...
room from it. There is no client-side relay-control HMAC or shared secret in the
distributed SWF. Legacy `worldId` controls are a guarded compatibility fallback.
